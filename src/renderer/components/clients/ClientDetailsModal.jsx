...
export default function ClientDetailsModal({ customer, onClose, onSave, onDelete }) {
  ...
  return (
    <div className="modal-backdrop">
      <div className="modal-window modal-client">
        <div className="modal-header">
          <div>
            <div className="modal-title">Cliente: {editing.name}</div>
            <div className="modal-subtitle">Edite os dados.</div>
          </div>
